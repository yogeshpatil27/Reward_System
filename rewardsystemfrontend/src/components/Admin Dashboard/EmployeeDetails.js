  ...
  <tbody>
{
  ...
  {return(
   ...
   <td>
    <button className="Edit" onClick={()=>history.push(`/edit/${e._id}`)} component={ Link } to={`/edit/${e._id}`}>Edit</button>
  <button className="Delete" onClick={()=>DeleteEmployee(e._id)}>Delete</button>
  </td>
  </tr>
